...
public static class FeatureSchema
{
        ...
        CancellationToken ct = default)
    {
        ...
        [
            ...
            """UPDATE "TheoryTrainingSettings" SET "LicenseCategoryPoliciesJson" = COALESCE("LicenseCategoryPoliciesJson", '{}');""",
            """UPDATE "TheoryTrainingSettings" SET "SavedBookingPresetsJson" = COALESCE("SavedBookingPresetsJson", '[]');""",
            """UPDATE "TheoryTrainingSettings" SET "HiddenBookingPresetKeysJson" = COALESCE("HiddenBookingPresetKeysJson", '[]');""",
            """ALTER TABLE "TheoryTrainingSettings" ALTER COLUMN "LicenseCategoryPoliciesJson" SET DEFAULT '{}';""",
            """ALTER TABLE "TheoryTrainingSettings" ALTER COLUMN "SavedBookingPresetsJson" SET DEFAULT '[]';""",
            """ALTER TABLE "TheoryTrainingSettings" ALTER COLUMN "HiddenBookingPresetKeysJson" SET DEFAULT '[]';""",
            """ALTER TABLE "SchoolStudentEnrollments" ADD COLUMN IF NOT EXISTS "AttendanceDayType" varchar(16) NULL;""",
            """ALTER TABLE "SchoolStudentEnrollments" ADD COLUMN IF NOT EXISTS "AllowedStartTime" time NULL;""",
            """ALTER TABLE "SchoolStudentEnrollments" ADD COLUMN IF NOT EXISTS "LicenseCategories" varchar(32) NULL;""",
            """ALTER TABLE "SchoolStudentEnrollments" ADD COLUMN IF NOT EXISTS "TheoryExamAuthorized" boolean NOT NULL DEFAULT FALSE;""",
