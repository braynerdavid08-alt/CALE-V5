...
@Component({
  ...
  template: `
    ...
    <ui-card>
      <p class="lead">
        Módulo reservado en el Dashboard de administrador. La navegación ya está lista;
        la funcionalidad se desarrollará en una siguiente iteración.
      </p>
      <ul class="notes">
...
export class AdminPlaceholderPage {
  ...
  readonly subtitle = String(
    this.data['subtitle'] ?? 'Esta sección formará parte del panel de administración.'
  );
  readonly eyebrow = String(this.data['eyebrow'] ?? 'Administración');
