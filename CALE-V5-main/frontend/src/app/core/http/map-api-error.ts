...
const messages: Record<string, string> = {
  ...
  exam_empty_bank: 'El banco del examen no tiene preguntas activas.',
  exam_needs_answer_review: 'Hay preguntas sin clave correcta. Revísalas antes de publicar.',
  exam_not_published: 'Publica el examen antes de asignarlo a un grupo.',
  exam_group_exists: 'Ese examen ya está asignado a ese grupo.',
  group_forbidden: 'No puedes asignar a un grupo que no es tuyo.',
  ...
  attempt_not_found: 'No encontramos ese intento de examen.',
  attempt_not_finished: 'La revisión solo está disponible cuando el examen ya terminó.',
  question_not_found: 'Alguna pregunta del intento ya no está en el catálogo. Intenta de nuevo o contacta a tu instructor.',
  ...
  attempt_reclaimed_retry: 'El intento anterior expiró. Intenta iniciar de nuevo.',
  ...
  buzz_closed: 'El buzzer no está abierto.',
  buzz_taken: 'Otro equipo ya ganó el buzzer.',
  ...
  saturday_day_limit: 'Ya reservaste el máximo de clases permitidas este sábado.',
  daily_minutes_limit: 'Alcanzaste el límite diario de minutos de teoría de tu escuela.',
  schedule_overlap: 'Ya tienes una clase que se cruza con ese horario.',
  ...
  theory_exam_not_configured: 'Configura el examen teórico oficial en Ajustes antes de continuar.',
